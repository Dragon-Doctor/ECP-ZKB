...
static const __m256d V_B_K_2_INV = {BINARY_SAMPLER_B_K_2_INV, BINARY_SAMPLER_B_K_2_INV, BINARY_SAMPLER_B_K_2_INV, BINARY_SAMPLER_B_K_2_INV};
static const __m256d V_BA_10_K_2_INV = {BINARY_SAMPLER_BA_10_K_2_INV, BINARY_SAMPLER_BA_10_K_2_INV, BINARY_SAMPLER_BA_10_K_2_INV, BINARY_SAMPLER_BA_10_K_2_INV};
static const __m256d V_BRS_13_K_2_INV = {BINARY_SAMPLER_BRS_13_K_2_INV, BINARY_SAMPLER_BRS_13_K_2_INV, BINARY_SAMPLER_BRS_13_K_2_INV, BINARY_SAMPLER_BRS_13_K_2_INV};
...
static void uniform_sampler_b_k(const unsigned char *r, __m256i *y1, __m256i *y2)
{
...
static void uniform_sampler_ba_10_k(const unsigned char *r, __m256i *y1, __m256i *y2)
{
    uint64_t sample[8] __attribute__ ((aligned (32)));
    uint32_t i = 0, j = 0;
    uint64_t x;
    ...
    while (j < 8)
    {
        ...
        x = x - ((((x * BARRETT_FACTOR_BA_10_K) >> BARRETT_BITSHIFT_BA_10_K) + 1) * BA_10_K);
        x = x + (x >> 63) * BA_10_K;
...
static void uniform_sampler_brs_13_k(const unsigned char *r, __m256i *y1, __m256i *y2)
{
    uint64_t sample[8] __attribute__ ((aligned (32)));
    uint32_t i = 0, j = 0;
    uint64_t x;
    ...
    while (j < 8)
    {
        ...
        x = x - ((((x * BARRETT_FACTOR_BRS_13_K) >> BARRETT_BITSHIFT_BRS_13_K) + 1) * BRS_13_K);
        x = x + (x >> 63) * BRS_13_K;
...
uint64_t rej_op(const POLY_R z_out[][N + K + 1], const POLY_R *z1, const POLY_R *z2, const POLY_R *z0, const POLY_R *zb, const POLY_R x_rout[][N + K + 1], const POLY_R *x_rho, const POLY_R *x_aut_rho, const POLY_R *x_ri, const POLY_R *x_rb)
{
    unsigned char r[REJ_BERNOULLI_ENTRY_SIZE];
