...
{
    return con_add((t & RED_SHORT_MASK_Q) - ((t >> RED_SHORT_SHIFT_1_Q) * RED_SHORT_CONST_Q), Q);
}

static inline uint64_t red_short_qhat(uint64_t t)
{
    return con_sub((t & RED_SHORT_MASK_QHAT) + ((t >> RED_SHORT_SHIFT_1_QHAT) * RED_SHORT_CONST_QHAT), QHAT);
}
...
{
    return montgomery(a, b, QHAT, MONTGOMERY_FACTOR_QHAT, MONTGOMERY_SHIFT_QHAT, MONTGOMERY_MASK_QHAT);
}
